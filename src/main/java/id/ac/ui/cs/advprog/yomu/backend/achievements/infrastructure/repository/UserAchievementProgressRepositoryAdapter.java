...
public class UserAchievementProgressRepositoryAdapter
  ...
  public UserAchievementProgressRepositoryAdapter(
      SpringDataUserAchievementProgressRepository repository) {
    this.repository = repository;
  }

  @Override
  public Optional<UserAchievementProgress> findByUserIdAndAchievementId(
  ...
  @Override
  public List<UserAchievementProgress> findByUserIdAndIsCompleted(
