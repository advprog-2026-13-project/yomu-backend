...
public class DailyMissionScheduler {
    ...
    public DailyMissionScheduler(IUserDailyMissionProgressRepository userDailyMissionProgressRepository) {
        this.userDailyMissionProgressRepository = userDailyMissionProgressRepository;
    }

    /**
     * Resets/cleans up daily mission progress.
     * Runs every day at 00:00:00.
     * It deletes the daily missions progress from the previous day to keep the database clean.
     */
