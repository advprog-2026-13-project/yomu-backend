...
public class AdminContentController {
    ...
    public ResponseEntity<Reading> updateReading(@PathVariable UUID id, @RequestBody Reading updatedReading) {
    ...
    public ResponseEntity<Question> addQuestion(@PathVariable UUID readingId, @RequestBody Question question) {
        return ResponseEntity.ok(adminContentService.addQuestionToReading(readingId, question));
    }

    @PutMapping("/questions/{questionId}")
    public ResponseEntity<Question> updateQuestion(@PathVariable UUID questionId, @RequestBody Question updatedQuestion) {
