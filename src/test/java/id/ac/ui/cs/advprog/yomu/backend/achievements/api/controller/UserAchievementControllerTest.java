...
class UserAchievementControllerTest {
  ...
  @Mock private AchievementQueryService queryService;

  @InjectMocks private UserAchievementController controller;
  ...
  void testGetAllDailyMissions() throws Exception {
    ...
    mockMvc
        .perform(get("/api/achievements/daily-missions"))
        .andExpect(status().isOk())
  ...
  void testGetUserAchievementProgress() throws Exception {
    ...
    mockMvc
        .perform(get("/api/achievements/users/" + userId + "/progress"))
        .andExpect(status().isOk())
  ...
  void testGetUserDailyMissionProgress() throws Exception {
    ...
    mockMvc
        .perform(get("/api/achievements/users/" + userId + "/daily-progress"))
        .andExpect(status().isOk())
  ...
  void testGetCompletedAchievements() throws Exception {
    ...
    mockMvc
        .perform(get("/api/achievements/users/" + userId + "/completed"))
        .andExpect(status().isOk())
