...
class AchievementAdminServiceTest {
    ...
    void testCreateAchievement() {
        ...
        Achievement result = adminService.createAchievement("Test", "Desc", AchievementType.READING_COMPLETED, 10);
    ...
    void testCreateDailyMission() {
        ...
        DailyMission result = adminService.createDailyMission("Mission", "Desc", AchievementType.QUIZ_COMPLETED, 5);
